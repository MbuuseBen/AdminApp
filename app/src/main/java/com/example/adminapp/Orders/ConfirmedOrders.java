...
public class ConfirmedOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle("Confirmed Orders");
                    ...
                    protected void onBindViewHolder(@NonNull @NotNull NewOrdersActivity.AdminOrdersViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull @NotNull AdminOrders model) {
                        ...
                        holder.ShowOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(ConfirmedOrders.this, OrderDetailsActivity.class);
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(ConfirmedOrders.this);
